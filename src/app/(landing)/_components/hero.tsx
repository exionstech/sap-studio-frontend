  ...
  return (
    <div className="w-full max-w-screen-2xl mx-auto px-5 md:px-14 flex md:flex-row flex-col gap-5">
      <div className="w-full md:w-[50%] flex flex-col gap-10">
        <h1 className="font-larken-demo text-4xl md:text-5xl lg:text-6xl">Decode Nature&apos;s <br /> Secret <span className="text-green3">Symphony</span></h1>
      ...
      <div className="w-full md:w-[50%] flex items-end md:pt-[4.5rem] justify-end">
          <Image
